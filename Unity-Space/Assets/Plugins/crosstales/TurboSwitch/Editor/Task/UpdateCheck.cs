...
namespace Crosstales.TPS.Task
{
   ...
   public static class UpdateCheck
   {
      ...
      private static string update2019(string[] data)
      {
         ...
         if (data != null)
         {
            sb.Append(Constants.ASSET_NAME + " " + Constants.ASSET_VERSION);
      ...
      private static string[] readData()
      {
         ...
         try
         {
            ...
            using (System.Net.WebClient client = new Common.Util.CTWebClient())
            {
               ...
               foreach (var line in Helper.SplitStringToLines(content).Where(line => line.StartsWith(Constants.ASSET_UID.ToString())))
               {
